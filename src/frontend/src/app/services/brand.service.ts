...
export class BrandService {
  ...
  create_brand(name: string, description: string): Observable<string> {
    ...
    return this.http.post<string>(environment.baseUrl + '/brands', body, {
      headers: header,
    });
  }
  ...
  update_brand(name: string, description: string): Observable<string> {
    ...
    return this.http.patch<string>(
      environment.baseUrl + '/brands/' + name,
      body,
      { headers: header }
    );
  }

  get_brand(id: string): Observable<Brand> {
    return this.http.get<Brand>(environment.baseUrl + '/brands/' + id);
  }
  ...
  delete_brand(name: string): Observable<string> {
    ...
    return this.http.delete<string>(environment.baseUrl + '/brands/' + name, {
      headers: header,
    });
  }
}
